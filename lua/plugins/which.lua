    ...
    config = function ()
        ...
        wk.register({
            ...
            ["<leader>o"] = {
                ...
                e = { "<cmd>ObsidianTemplate<cr>", "Insert Obsidian Template" },
                a = { "<cmd>ObsidianOpen<cr>", "Open Obsidian App" },
                b = { "<cmd>ObsidianBacklinks<cr>", "Show ObsidianBacklinks" },
                l = { "<cmd>ObsidianLinks<cr>", "Show ObsidianLinks" },
                n = { "<cmd>ObsidianNew<cr>", "Create New Note" },
                s = { "<cmd>ObsidianSearch<cr>", "Search Obsidian" },
                q = { "<cmd>ObsidianQuickSwitch<cr>", "Quick Switch" },
                d = { "<cmd>ObsidianDailies<cr>", "Daily Note" },
